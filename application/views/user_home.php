        ...
        <ul>
          <li>
            ...
            in the Province, roads and bridges, public buildings, flood mitigation structures and drainage system and water management system.  </p>
           	<p class="readmore"><a href="<?php echo $this->config->item('base_url')?>welcome/about?about=0">Continue Reading &raquo;</a></p>
          </li>
          <li>
             <h2 class="h2-link">
            ...
            <p class="readmore"><a href="<?php echo $this->config->item('base_url')?>welcome/about?about=1">Continue Reading &raquo;</a></p>
          </li>
          <li class="last">
             <h2 class="h2-link ">
           ...
           <p class="readmore"><a href="<?php echo $this->config->item('base_url')?>welcome/about?about=2">Continue Reading &raquo;</a></p>
          </li>
          <li>
             <h2 class="h2-link ">
          ...
          <li>
           ...
           <li class="last">
            ...
            <p>Nullamlacus dui ipsum conseqlo borttis non euisque morbipen a sdapibulum orna.</p>
            <p>Urnau ltrices quis curabitur pha sellent esque congue magnisve stib ulum quismodo nulla et feugiat. Adipisciniap ellentum leo ut consequam.</p>
            <p class="readmore"><a href="<?php echo $this->config->item('base_url')?>welcome/about?about=5">Continue Reading &raquo;</a></p>
          </li>
          <li></li>
          <li>
            ...
            <p>Under the Program support component is the Integrated Tax Management System (iTax) Regional Support Center, a proposed 
            	...
            	least 129 municipalities in 11 provinces. All the 41 munici ...</p>
          ...
          <li>
            ...
            <p>Nullamlacus dui ipsum conseqlo borttis non euisque morbipen a sdapibulum orna.</p>
            <p>Urnau ltrices quis curabitur pha sellent esque congue magnisve stib ulum quismodo nulla et feugiat. Adipisciniap ellentum leo ut consequam.</p>
           <p class="readmore"><a href="<?php echo $this->config->item('base_url')?>welcome/about?about=7">Continue Reading &raquo;</a></p>
          </li>
          <li class="last">
             <h2 class="h2-link"><a href="#">Addendum</a></h2>
            <div class="imgholder"><img src="<?php echo $this->config->item('base_asset')?>images/addendum.png" alt="" /></div>
            <p>Nullamlacus dui ipsum conseqlo borttis non euisque morbipen a sdapibulum orna.</p>
            <p>Urnau ltrices quis curabitur pha sellent esque congue magnisve stib ulum quismodo nulla et feugiat. Adipisciniap ellentum leo ut consequam.</p>
           <p class="readmore"><a href="<?php echo $this->config->item('base_url')?>welcome/about?about=8">Continue Reading &raquo;</a></p>
          </li>
        </ul>
        <br class="clear" />
    </div>
